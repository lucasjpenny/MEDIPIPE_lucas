#!/bin/bash
#SBATCH -p long              ## Specify SLURM partition for job submssion
#SBATCH -t 8-00:00 # been so long:00:00
#SBATCH --mem=5G
...
snakemake --snakefile /cluster/home/t116306uhn/workflows/MEDIPIPE_lucas/workflow/Snakefile  \
          --configfile /cluster/home/t116306uhn/workflows/MEDIPIPE_lucas/workflow/20250619_fullCohort_config_template.yaml \
          --unlock
...
snakemake --snakefile /cluster/home/t116306uhn/workflows/MEDIPIPE_lucas/workflow/Snakefile \
          ...
          --cluster "sbatch -p {cluster.partition} -c {cluster.cpus} --mem={cluster.mem} -t {cluster.time} -o {cluster.std} -e {cluster.err}" \
          --latency-wait 60 --jobs 200 -p --rerun-incomplete --keep-going #--dry-run #--dag | dot -Tsvg > dag.svg
